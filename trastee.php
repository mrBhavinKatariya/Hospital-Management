...
<div id="id01" class="modal"> 
  ...
  <form class="modal-content animate" action="#" method="post" autocomplete="off">
    ...
    <div class="container">
      ...
      <button type="submit" name="login_trustee" class="nlogin" >LOGIN</button>
...
if(isset($_POST['login_trustee']))
{
    $username=$_POST['username'];
    $password=$_POST['pssword'];

    $query="SELECT * FROM ttable WHERE username ='$username' &&  pssword='$password' ";
    ...
    if($total == 1)
    {
        ...
        $_SESSION['user_name'] = $username;
           ?>
                ...
                <meta http-equiv = "refresh" content = "1; url=http://localhost/shyam%20hospital/Hospital/action_page1.php"/>
