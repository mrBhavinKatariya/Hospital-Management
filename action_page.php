...
<form action="http://localhost/shyam%20hospital/Hospital/loginforadmin.php?" method="get">
    <a href="logout.php">
...
?>
<table border="2px" align="center" style="background:white;border-radius:10px;width:85%;" cellpadding="8" cellspacing="0">
    <tr>
        ...
        <th colspan="5" class="table" style="width:12%">Actions</th>
    </tr>
    <?php
...
<div class="credit">Copyright © 2023 <a href="http://localhost/shyam%20hospital/Hospital/action_page.php"><span>Shyam Cheritable Trust</span></a>. All Rights Reserved </div>
